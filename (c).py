...
if __name__ == "__main__":
    src = cv2.imread('C:/Users/Jinxi/Desktop/Test_Image.pgm', 0)
    filtered_image_OpenCV = cv2.bilateralFilter(src, 50, 10, 10)
    #cv2.imwrite("original_image_grayscale.png", src)
    cv2.imwrite("filtered_image_OpenCV_7.png", filtered_image_OpenCV)
    #filtered_image_own = bilateral_filter_own(src, 15, 12.0, 16.0)
